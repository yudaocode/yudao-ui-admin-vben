<template>
  <PageWrapper contentBackground title="按钮权限控制" contentClass="p-4">
    ...
    <Divider />
    <a-button type="primary" class="mr-2" @click="switchToken(2)" :disabled="!isBackPermissionMode"> 点击切换按钮权限(用户id为2) </a-button>
    <a-button type="primary" @click="switchToken(1)" :disabled="!isBackPermissionMode"> 点击切换按钮权限(用户id为1,默认) </a-button>
