        ...
        <div class="bg-[var(--ant-color-bg-container)]">
          ...
          >
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="flex justify-end gap-2">
                <ElButton size="small" @click="namePopoverVisible = false">
                  取消
                </ElButton>
                <ElButton size="small" type="primary" @click="saveName">
                  保存
                </ElButton>
              </div>
            </div>
          ...
          >
            ...
            <div class="flex flex-col gap-2">
              ...
              />
              <div class="flex justify-end gap-2">
                <ElButton size="small" @click="noticePopoverVisible = false">
                  取消
                </ElButton>
                <ElButton size="small" type="primary" @click="saveNotice">
                  保存
                </ElButton>
              </div>
            </div>
          ...
          >
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="flex justify-end gap-2">
                ...
                <ElButton size="small" type="primary" @click="saveGroupRemark">
                  保存
                </ElButton>
              </div>
            </div>
          ...
          >
            ...
            <div class="flex flex-col gap-2">
              ...
              />
              <div class="flex justify-end gap-2">
                <ElButton size="small" @click="remarkPopoverVisible = false">
                  取消
                </ElButton>
                <ElButton size="small" type="primary" @click="saveRemark">
                  保存
                </ElButton>
              </div>
            </div>
        ...
        <template v-if="isOwner || (isOwnerOrAdmin && !!group.joinApproval)">
          ...
          <div class="bg-[var(--ant-color-bg-container)]">
            ...
            >
              ...
              <ElSwitch
                :model-value="!!group.joinApproval"
