...
async function onMuteAllChange(value: boolean | number | string) {
  ...
  ElMessage.success(newValue ? '已开启全群禁言' : '已关闭全群禁言')
  emit('reload')
}
        ...
        <div class="bg-[var(--ant-color-bg-container)]">
          ...
          >
            ...
            <div class="flex flex-col gap-2">
              <ElInput v-model="editName" :maxlength="20" placeholder="请输入群聊名称" />
              <div class="flex justify-end gap-2">
                <ElButton size="small" @click="namePopoverVisible = false">取消</ElButton>
          ...
          >
            ...
            <div class="flex flex-col gap-2">
              ...
              />
              <div class="flex justify-end gap-2">
                <ElButton size="small" @click="noticePopoverVisible = false">取消</ElButton>
                <ElButton size="small" type="primary" @click="saveNotice">保存</ElButton>
              </div>
            </div>
          </ElPopover>
          <div
          ...
          >
            ...
            <div class="flex flex-col gap-2">
              ...
              />
              <div class="flex justify-end gap-2">
                <ElButton size="small" @click="groupRemarkPopoverVisible = false">取消</ElButton>
                <ElButton size="small" type="primary" @click="saveGroupRemark">保存</ElButton>
              </div>
            </div>
          </ElPopover>
          ...
          >
            ...
            <div class="flex flex-col gap-2">
              <ElInput v-model="editRemark" :maxlength="20" placeholder="请输入本群昵称" />
              <div class="flex justify-end gap-2">
                <ElButton size="small" @click="remarkPopoverVisible = false">取消</ElButton>
                <ElButton size="small" type="primary" @click="saveRemark">保存</ElButton>
              </div>
            </div>
          </ElPopover>
        </div>
