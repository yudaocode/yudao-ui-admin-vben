...
<template>
  ...
  <div class="flex flex-1 min-w-0 h-full">
    ...
    >
      ...
      >
        <ElInput v-model="keyword" placeholder="搜索" clearable class="flex-1">
          <template #prefix>
            <Icon icon="ant-design:search-outlined" />
          </template>
        </ElInput>
        <ElDropdown trigger="click" placement="bottom">
          <ElButton size="small" circle>
            <Icon icon="ant-design:plus-outlined" />
          </ElButton>
          <template #dropdown>
            <ElDropdownMenu>
              <ElDropdownItem @click="handleOpenCreateGroup">
                <span class="inline-flex items-center gap-2">
                  <Icon icon="ant-design:message-outlined" :size="16" />
                  <span>发起群聊</span>
                </span>
              </ElDropdownItem>
              <ElDropdownItem @click="friendAddDialogRef?.open()">
                <span class="inline-flex items-center gap-2">
