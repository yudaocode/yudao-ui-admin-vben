...
<template>
  <div class="process-viewer">
    ...
    >
      <ElRow>
        <ElTable :data="selectTasks" size="small" border>
          <ElTableColumn label="序号" align="center" width="50">
          ...
          <ElTableColumn
            ...
            v-else
          />
          <ElTableColumn label="部门" width="100" align="center">
            <template #default="{ row }">
      ...
      <ElRow justify="end">
        <ElButtonGroup key="scale-control">
          ...
          <ElButton
            ...
            @click="processZoomIn()"
          />
          <ElButton :icon="UndoOutlined" @click="processReZoom()" />
        </ElButtonGroup>
      </ElRow>
    </div>
  </div>
