...
<template>
  <Page>
    ...
    <br />
    <Button type="link" target="_blank" href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/views/pay/order/index">
      可参考 https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/views/pay/order/index 代码，pull request 贡献给我们！
    </Button>
  </Page>
</template>