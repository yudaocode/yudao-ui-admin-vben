...
/** 编辑床位 */
function handleEdit(row: BedApi.Bed) {
...
async function handleExport() {
  const data = await exportBed(await gridApi.formApi.getValues());
  downloadFileFromBlobPart({ fileName: '床位.xls', source: data });
}
...
<template>
  <Page auto-content-height>
    ...
    <Grid table-title="床位列表">
      <template #toolbar-tools>
        <TableAction
          :actions="[
            {
              label: $t('ui.actionTitle.create', ['床位']),
              type: 'primary',
